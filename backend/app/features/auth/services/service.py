...
from app.core.exceptions.exceptions import ConflictError, UnauthorizedError, EntityNotFoundError, ValidationError

class AuthService:
    def __init__(self, repository: AuthRepository):
        self.repository = repository

    async def signup(self, email: str, password: str, full_name: str, role: str) -> UserDTO:
